...
--
-- Host: 127.0.0.1
-- Generation Time: Maj 30, 2025 at 03:29 PM
...
(4, 'maciek', 'maciek', 'mazur', 'ddcb56c65b4dd06f21600cea205014dc703fda73', 'brodnica');
...
(21, 3, '2026-05-25', 9000, '\'Nie zakończone!!!\'', 'Administracja'),
(22, 3, '2028-05-25', 9000, '\'Nie zakończone!!!\'', 'Administracja');
...
--
ALTER TABLE `pozycje_zamowienia`
  MODIFY `id_pozycji` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
